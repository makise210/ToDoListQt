...
MainWindow::MainWindow(){
        ...
        pWidget->setStyleSheet("backgrounnd-color: #ECF0F1");
        ...
        connect(m_pActAdd, &QAction::triggered, this, &MainWindow::onAdd);

        m_pActRemove = new QAction(this);
        m_pActRemove->setIcon(QIcon(":/resources/remove.png"));
        connect(m_pActRemove, &QAction::triggered, this, &MainWindow::onRemove);
